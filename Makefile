...
vundle:
	@test ! -e ${DOTFILES_DIR}/${VIM_DIR}/${VUNDLE_DIR} || \
		rm -rf ${DOTFILES_DIR}/${VIM_DIR}/${VUNDLE_DIR}

	@echo "Cloning Vundle from github.com..."
	@git clone git://github.com/gmarik/vundle.git ${DOTFILES_DIR}/${VIM_DIR}/${VUNDLE_DIR}
	@echo "Done.\n"
